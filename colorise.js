...
class colorise {
    ...
    getColorName = (colorCode) => {
        ...
        Object.entries(colorKeyValues).forEach(([key, value]) => {
            if(colorCode === key) {
                res = value;
                flag = 1;
            }
    ...
    rgbToHsl = (r,g,b) => {
        ...
        if(delta === 0) res.h = 0;
        else if(cmax === r) res.h = ((((g-b)/delta)%6)*60).toFixed(4);
        else if(cmax === g) res.h = ((((b-r)/delta)+2)*60).toFixed(4);
        else if(cmax === b) res.h = ((((r-g)/delta)+4)*60).toFixed(4);
    
        res.l = ((cmax + cmin)/2).toFixed(4);
    
        if(delta === 0) res.s = 0;
        else res.s = ((delta/(1-Math.abs(2*(res.l)-1)))).toFixed(4);
    ...
    rgbToHwb = (r,g,b) => {
        ...
        let temp = this.rgbToHsl(r,g,b);
        res.h = temp.h;

        res.w = (1/255*Math.min(r,Math.min(g,b))).toFixed(4);
        res.b = (1 - 1/255*Math.max(r,Math.max(g,b))).toFixed(4);
    ...
    lightenColor = (r,g,b,ratio) => {
        ...
        let arr = this.hslToRgb(res.h,res.s,res.l);
    ...
    hslToRgb = (h,s,l) => {
        ...
        let r = ((temp_r + m)*255).toFixed(4);
        let g = ((temp_g + m)*255).toFixed(4);
        let b = ((temp_b + m)*255).toFixed(4);
